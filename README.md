...
| ------- | ---------- | -------- | ---------- |
| [dev-lang/rust](https://codeberg.org/LinuxUserGD/overlay/tree/dev/dev-lang/rust) | 1.90.0 | [1.97.1](https://github.com/rust-lang/rust/tags) | [rust@gentoo.org](https://repology.org/maintainer/rust@gentoo.org) |

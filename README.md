...
| ------- | ---------- | -------- | ---------- |
| [dev-lang/rust](https://codeberg.org/LinuxUserGD/overlay/tree/dev/dev-lang/rust) | 1.90.0 | [1.96.0](https://github.com/rust-lang/rust/tags) | [rust@gentoo.org](https://repology.org/maintainer/rust@gentoo.org) |
